...
- [x] 5. **Test case repository** - folders, test cases, test steps, tags
...
- [x] 8. **Releases, builds & environments** - create and manage each
...
- [x] 10. **Test cycles** - create cycles under a plan, assign build/environment
